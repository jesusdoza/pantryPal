 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(_,V){var U=_.length;_.push(V);e:for(;0<U;){var te=U-1>>>1,I=_[te];if(0<i(I,V))_[te]=V,_[U]=I,U=te;else break e}}function n(_){return _.length===0?null:_[0]}function r(_){if(_.length===0)return null;var V=_[0],U=_.pop();if(U!==V){_[0]=U;e:for(var te=0,I=_.length,F=I>>>1;te<F;){var $=2*(te+1)-1,B=_[$],C=$+1,G=_[C];if(0>i(B,U))C<I&&0>i(G,B)?(_[te]=G,_[C]=U,te=C):(_[te]=B,_[$]=U,te=$);else if(C<I&&0>i(G,U))_[te]=G,_[C]=U,te=C;else break e}}return V}function i(_,V){var U=_.sortIndex-V.sortIndex;return U!==0?U:_.id-V.id}if(typeof performance=="object"&&typeof performance.now=="function"){var a=performance;e.unstable_now=function(){return a.now()}}else{var o=Date,l=o.now();e.unstable_now=function(){return o.now()-l}}var s=[],u=[],c=1,f=null,m=3,w=!1,g=!1,v=!1,b=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(_){for(var V=n(u);V!==null;){if(V.callback===null)r(u);else if(V.startTime<=_)r(u),V.sortIndex=V.expirationTime,t(s,V);else break;V=n(u)}}function S(_){if(v=!1,y(_),!g)if(n(s)!==null)g=!0,Ee(k);else{var V=n(u);V!==null&&ge(S,V.startTime-_)}}function k(_,V){g=!1,v&&(v=!1,d(O),O=-1),w=!0;var U=m;try{for(y(V),f=n(s);f!==null&&(!(f.expirationTime>V)||_&&!se());){var te=f.callback;if(typeof te=="function"){f.callback=null,m=f.priorityLevel;var I=te(f.expirationTime<=V);V=e.unstable_now(),typeof I=="function"?f.callback=I:f===n(s)&&r(s),y(V)}else r(s);f=n(s)}if(f!==null)var F=!0;else{var $=n(u);$!==null&&ge(S,$.startTime-V),F=!1}return F}finally{f=null,m=U,w=!1}}var P=!1,E=null,O=-1,L=5,z=-1;function se(){return!(e.unstable_now()-z<L)}function X(){if(E!==null){var _=e.unstable_now();z=_;var V=!0;try{V=E(!0,_)}finally{V?ae():(P=!1,E=null)}}else P=!1}var ae;if(typeof p=="function")ae=function(){p(X)};else if(typeof MessageChannel<"u"){var ee=new MessageChannel,q=ee.port2;ee.port1.onmessage=X,ae=function(){q.postMessage(null)}}else ae=function(){b(X,0)};function Ee(_){E=_,P||(P=!0,ae())}function ge(_,V){O=b(function(){_(e.unstable_now())},V)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(_){_.callback=null},e.unstable_continueExecution=function(){g||w||(g=!0,Ee(k))},e.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):L=0<_?Math.floor(1e3/_):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(_){switch(m){case 1:case 2:case 3:var V=3;break;default:V=m}var U=m;m=V;try{return _()}finally{m=U}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(_,V){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var U=m;m=_;try{return V()}finally{m=U}},e.unstable_scheduleCallback=function(_,V,U){var te=e.unstable_now();switch(typeof U=="object"&&U!==null?(U=U.delay,U=typeof U=="number"&&0<U?te+U:te):U=te,_){case 1:var I=-1;break;case 2:I=250;break;case 5:I=1073741823;break;case 4:I=1e4;break;default:I=5e3}return I=U+I,_={id:c++,callback:V,priorityLevel:_,startTime:U,expirationTime:I,sortIndex:-1},U>te?(_.sortIndex=U,t(u,_),n(s)===null&&_===n(u)&&(v?(d(O),O=-1):v=!0,ge(S,U-te))):(_.sortIndex=I,t(s,_),g||w||(g=!0,Ee(k))),_},e.unstable_shouldYield=se,e.unstable_wrapCallback=function(_){var V=m;return function(){var U=m;m=V;try{return _.apply(this,arguments)}finally{m=U}}}})(i0);(function(e){e.exports=i0})(Ky);/**
 * @license React
...
`;function sE(){const e="",t=x.useRef(""),n=x.useRef(""),r=x.useRef(""),i=x.useRef("");let a=t.current.value,o=n.current.value,l=r.current.value,s=i.current.value;const[u,c]=x.useState(!1),[f,m]=x.useState([]),[w,g]=x.useState(!1),[v,b]=x.useState(!1),[d,p]=x.useState(!1),y=cs();function S(E){return new RegExp(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/).test(E)}function k(){let E=[];return!S(s)&&s&&(b(!0),E.push("email format invalid")),o!==l&&(p(!0),E.push("passwords do not match")),E.length>0?(c(!0),E):[]}async function P(){c(!1);const E=k();if(E.length>0){m(E);return}try{const O=await fetch(`${e}/api/signup`,{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:s,username:a,password:o})});if(O.status==401)throw Error("Username and/or Email already exists");if(O.status!=201)throw Error(`server response error ${O.statusText}`)}catch(O){c(!0),m([O.message]);return}try{const O=await fetch(`${e}/api/login`,{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:a,password:o})});if(O.status===200){const L=await O.json();Fl.set("loggedIn",{token:L.token,username:a})}else throw Error(O.statusText)}catch(O){c(!0),m([O.message]);return}y("/search")}return h(lE,{children:N("section",{className:"signup-container",children:[h("div",{children:h("img",{src:jd,alt:"Pantry Pal Logo",className:"logo"})}),N("section",{className:"form-sect",children:[N("form",{action:"#",onSubmit:E=>{E.preventDefault(),P()},children:[N("div",{className:"title",children:[h("h1",{children:"Welcome to Pantry Pal!"}),h("h2",{children:"Sign Up Here"})]}),N("div",{className:"input-container",children:[v&&h("span",{className:"error-marker",children:"*"}),h("label",{className:"input-tag",htmlFor:"email"}),h("input",{placeholder:"Email",className:v?"error-container":"",ref:i,onChange:E=>{s=E.target.value,b(!1)},id:"email",type:"text",required:!0}),v&&h("span",{className:"error-marker",children:"*"})]}),N("div",{className:"input-container",children:[w&&h("span",{className:"error-marker",children:"*"}),h("label",{className:"input-tag",htmlFor:"username"}),h("input",{placeholder:"Username",className:w?"error-container":"",ref:t,onChange:E=>{a=E.target.value},id:"username",type:"text",required:!0}),w&&h("span",{className:"error-marker",children:"*"})]}),N("div",{className:"input-container",children:[d&&h("span",{className:"error-marker",children:"*"}),h("label",{className:"input-tag",htmlFor:"password"}),h("input",{placeholder:"Password",className:d?"error-container":"",ref:n,onChange:E=>{o=E.target.value,p(!1)},id:"password",type:"password",required:!0}),d&&h("span",{className:"error-marker",children:"*"})]}),N("div",{className:"input-container",children:[d&&h("span",{className:"error-marker",children:"*"}),h("label",{htmlFor:"confirmpassword",className:"input-tag"}),h("input",{placeholder:"Confirm Password",className:d?"error-container":"",ref:r,onChange:E=>{l=E.target.value,p(!1)},id:"confirmpassword",type:"password",required:!0}),d&&h("span",{className:"error-marker",children:"*"})]}),h("div",{className:"submit-btn-container",children:h("button",{className:"signup-btn",children:"Sign Up"})})]}),u&&h("section",{className:"error-container error-desc",children:N("div",{children:[h("h4",{children:"Please correct following errors"}),h("ul",{children:f.map((E,O)=>h("li",{children:E},O))})]})})]}),N("div",{className:"goto-btn",children:[h("span",{children:"Already have an account?"}),h(nt,{className:"page",to:"/login",children:"Sign in"})]})]})})}let Ti="#2C4001",uE="#F2E7AE";const cE=ot.section`
...
`;function u6(){const[e,t]=x.useState([]),n="",{userProfile:r}=x.useContext(bi);return x.useEffect(()=>{async function i(){try{const a=await zs.post(`${n}/api/getSavedRecipes`,{username:r.username});t(a.data)}catch(a){console.error("Error fetching saved recipes:",a)}}i()},[]),N(s6,{children:[h("div",{className:"title",children:h("h1",{children:"Saved Recipes"})}),h("div",{className:"saved-recipes",children:h("ul",{children:e.map(i=>h("li",{children:h(Ov,{recipe:i.recipeJson,showDelete:!0})},i._id))})})]})}let rr="#2C4001",Wh="#dae082",c6="#F2E7AE",Nr="#F2F2F2";const f6=ot.section`
    height: 100%;
...
`;function d6(){const e=x.useRef(null),t=x.useRef(null),[n,r]=x.useState(""),[i,a]=x.useState(""),[o,l]=x.useState(null),s=cs(),{userProfile:u,isLoggedIn:c,setIsLoggedIn:f,setUserProfile:m}=x.useContext(bi);return x.useEffect(()=>{e.current.focus()},[]),h(f6,{children:N("section",{className:"login-container",children:[h("div",{children:h("img",{src:jd,alt:"Pantry Pal Logo",className:"logo"})}),h("section",{className:"form-sect",children:N("form",{onSubmit:async g=>{g.preventDefault();try{const b=(await zs.post("/api/login",{username:n,password:i},{crossDomain:!0,withCredentials:!0})).data;f(!0),m(d=>b.userProfile?{...d,...b.userProfile}:d),s("/search")}catch(v){f(!1),console.log(v)}},children:[N("div",{className:"title",children:[h("div",{children:c&&"logged in"}),h("h2",{children:"Welcome Back!"})]}),o&&h("div",{className:"error-container",children:N("div",{className:"error-desc",children:[h("span",{className:"error-marker",children:"⚠"})," ",o]})}),N("div",{className:"input-container",children:[h("label",{className:"input-tag",htmlFor:"username"}),h("input",{id:"username",type:"text",placeholder:"Username",ref:e,value:n,onChange:g=>r(g.target.value),required:!0})]}),N("div",{className:"input-container",children:[h("label",{className:"input-tag",htmlFor:"password"}),h("input",{id:"password",type:"password",placeholder:"Password",ref:t,value:i,onChange:g=>a(g.target.value),required:!0})]}),h("div",{className:"submit-btn",children:h("button",{type:"submit",className:"btn",children:"Sign In"})}),h("span",{children:"Don't have an account?"}),h(nt,{className:"page",to:"/signup",children:"Sign up"})]})})]})})}let Lt="#2C4001",No="#F2E7AE",Yh="#59320F",Uu="#F2F2F2";const p6=ot.section`
.recipeImgContainer {
  height: 50%;
  text-align: center;
  color: white;
...
`;let Ro;const m6=new Uint8Array(16);function h6(){if(!Ro&&(Ro=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!Ro))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return Ro(m6)}const Ye=[];for(let e=0;e<256;++e)Ye.push((e+256).toString(16).slice(1));function g6(e,t=0){return(Ye[e[t+0]]+Ye[e[t+1]]+Ye[e[t+2]]+Ye[e[t+3]]+"-"+Ye[e[t+4]]+Ye[e[t+5]]+"-"+Ye[e[t+6]]+Ye[e[t+7]]+"-"+Ye[e[t+8]]+Ye[e[t+9]]+"-"+Ye[e[t+10]]+Ye[e[t+11]]+Ye[e[t+12]]+Ye[e[t+13]]+Ye[e[t+14]]+Ye[e[t+15]]).toLowerCase()}const v6=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),Gh={randomUUID:v6};function Nt(e,t,n){if(Gh.randomUUID&&!t&&!e)return Gh.randomUUID();e=e||{};const r=e.random||(e.rng||h6)();if(r[6]=r[6]&15|64,r[8]=r[8]&63|128,t){n=n||0;for(let i=0;i<16;++i)t[n+i]=r[i];return t}return g6(r)}function y6(){var u;const t=(u=yi().state)==null?void 0:u.recipe,n=t.dishTypes.map(c=>h("li",{children:c},Nt())),r=t.extendedIngredients.map(c=>N("li",{children:[c.amount," ",c.unit," ",h("img",{src:`https://spoonacular.com/cdn/ingredients_100x100/${c.image}`})," ",c.name]},Nt()));console.log(t);const i=t.analyzedInstructions[0].steps.map(c=>h("li",{children:c.step},Nt())),a=t.summary.replace(/<.*?>/g,""),o=t.extendedIngredients.length,l=t.aggregateLikes,s=t.diets.map(c=>h("li",{children:c},Nt()));return h(p6,{children:N("div",{className:"recipeContainer",children:[N("div",{className:"recipeImgContainer",children:[N("div",{className:"imageContainer",children:[h("img",{className:"recipeImg",src:t.image,alt:t.title}),h("button",{className:"saveBtn",children:h(it,{icon:ah,className:"saveIcon"})})]}),N("section",{className:"recipeDetails",children:[h("div",{className:"titleContainer",children:h("h1",{className:"recipeTitle",children:t.title})}),N("div",{className:"quickInfoContainer",children:[N("section",{className:"quickInfoItem",children:[h(it,{icon:J4,className:"quickIcon"}),N("h2",{className:"recipeTime",children:[t.readyInMinutes," minutes"]})]}),N("section",{children:[h(it,{icon:q4,className:"quickIcon"}),N("h2",{className:"recipeTime",children:[o," Ingredients"]})]}),N("section",{children:[h(it,{icon:ah,className:"quickIcon"}),N("h2",{className:"recipeTime",children:[l," Likes"]})]})]}),h("section",{className:"recipeSummary",children:h("p",{children:a})}),N("section",{className:"recipeTags",children:[h("div",{className:"recipeCategory",children:n}),h("div",{className:"recipeDiets",children:s})]})]})]}),h("div",{className:"recipeHead",children:h("div",{className:"recipeStart",children:N("div",{className:"ingredientCard",children:[N("h2",{children:["Servings: ",t.servings]}),h("input",{type:"number",placeholder:t.servings}),h("h2",{children:"What you'll need:"}),h("div",{className:"recipeIngredient",children:r})]})})}),N("div",{className:"instructionsCard",children:[h("h2",{children:t.title}),N("div",{className:"instructionContainer",children:[h("div",{children:h("img",{className:"instructionImg",src:t.image,alt:t.title})}),N("div",{className:"recipeInstructions",children:[h("h2",{children:"Instructions:"}),h("ol",{children:i})]})]})]})]})})}async function w6(e,t,n){const r="http://localhost:4000/api/getMealPlanner";try{const i=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({numberOfDays:e,dietType:t,dailyCalories:n})});if(!i.ok)throw new Error(`HTTP error ${i.status}`);return await i.json()}catch(i){return console.error("Error:",i),null}}const b6=ot.section`
  width: max(50%, 800px);
  padding: 2%;
  border-radius: 20px;
  margin: 2% auto;
...
`;function x6(){const[e,t]=x.useState(!1),[n,r]=x.useState(1),[i,a]=x.useState("None"),[o,l]=x.useState(""),[s,u]=x.useState(null);return N(b6,{children:[N("form",{onSubmit:async f=>{t(!0),f.preventDefault();const m=await w6(n,i,parseInt(o));u(m),t(!1)},children:[h("label",{htmlFor:"numberOfDays",children:"Number of days:"}),N("select",{id:"numberOfDays",value:n,onChange:f=>r(f.target.value),children:[h("option",{value:"1",children:"1"}),h("option",{value:"3",children:"3"}),h("option",{value:"5",children:"5"})]}),h("label",{htmlFor:"dietType",children:"Diet type:"}),N("select",{id:"dietType",value:i,onChange:f=>a(f.target.value),children:[h("option",{value:"None",children:"None"}),h("option",{value:"vegan",children:"Vegan"}),h("option",{value:"vegetarian",children:"Vegetarian"}),h("option",{value:"pescatarian",children:"Pescatarian"}),h("option",{value:"lacto-ovo-vegetarian",children:"Lacto-ovo-vegetarian"}),h("option",{value:"keto",children:"Keto"}),h("option",{value:"gluten-free",children:"Gluten-free"}),h("option",{value:"low-Fodmap",children:"Low Fodmap"})]}),h("label",{htmlFor:"dailyCalories",children:"Daily calories:"}),h("input",{id:"dailyCalories",type:"number",min:"0",step:"1",value:o,onChange:f=>l(f.target.value)}),h("button",{type:"submit",children:"Get Meal Plan"}),e?h(Av,{}):null]}),s&&N("table",{children:[h("thead",{children:N("tr",{children:[h("th",{children:"Day"}),h("th",{children:"Meal"}),h("th",{children:"Food"}),h("th",{children:"Calories"})]})}),h("tbody",{children:s.map(f=>{const m=Object.entries(f).filter(([g])=>g!=="Day"&&g!=="TotalCalories"),w=m.reduce((g,[,v])=>g+v.Calories,0);return m.flatMap(([g,v],b)=>[N("tr",{children:[b===0&&h("td",{rowSpan:m.length+1,children:f.Day}),h("td",{children:g}),h("td",{children:v.Meal}),h("td",{children:v.Calories})]},`${g}-${v.Meal}`),b===m.length-1&&h("tr",{children:N("td",{colSpan:"3",align:"right",children:["Total Day Calories :"," ",w]})},`${g}-TotalCalories`)])})})]})]})}const S6=Xx`
...
`,E6="#ffffff",C6="#40a140",k6=" #ffea00d0",P6=" #28bee4",O6="#ffffff",A6="#25271843",N6=ot.section`
    background: ${E6};
...
`,R6="#2b3f0124",I6="#eae6e6",_6="#a8a6a6",F6="#000000",T6="#595959f",$6=ot.section`
    width: 100%;
    position: fixed;
    top: 0;
    bottom: 0;
...
`,M6="/assets/error-58915e09.png";function tp({errorsArr:e=["errorsArr Empty"],showError:t=!1}){function n(r){return r.map((a,o)=>h("li",{className:"error_container",children:N("div",{className:"error_item",children:[h("div",{className:"img__container",children:h("img",{src:M6,alt:"error symbol"})}),h("p",{children:a})]})},Nt()))}return t?h(D6,{children:h("div",{className:"error container",children:h("div",{className:"row",children:N("section",{className:"container col",children:[h("h3",{children:"Please correct errors"}),h("ul",{className:"error__list",children:e.length>0?n(e):h(rn,{})})]})})})}):h(rn,{})}function z6({children:e,setIsDisplayed:t,scrollToRef:n}){x.useRef("");function r(){t(!1)}return h($6,{children:N("main",{children:[h("div",{onClick:()=>{r()},className:"back__blur "}),h("div",{ref:n,className:"container row ",children:h("section",{id:"modal",className:"",children:e})})]})})}const Bu=zs.create({baseURL:"",headers:{"Content-Type":"application/json"},withCredentials:!0});function Kh(e,t){return e===t}function j6(e){return new RegExp(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/).test(e)}async function V6(e,t){const n=await JSON.stringify({token:t,username:e});Fl.set("loggedIn",n),Fl.set("loggedIn",n)}const Io={updatePassword:async e=>{const{newPassword:t,confirmNewPassword:n,oldPassword:r}=e;let i={};try{if(!Kh(t,n))throw Error("passwords dont match")}catch(a){throw console.log("password confirm error"),Error(a.message)}try{if(i=await Bu.put("/api/profile/password",{newPassword:t,oldPassword:r}),i.data.profileUpdate){console.log("token update ");const a=i.data.username,o=i.data.token;await V6(a,o)}}catch(a){throw console.log("server request sent and error"),Error(a.response.data.message)}return console.log("password update success"),i},updateEmail:async e=>{const{newEmail:t,confirmNewEmail:n}=e;let r={};console.log("update email service front");try{if(!Kh(t,n))throw Error("emails dont match");if(!j6(t))throw Error("emails improper format");return r=await Bu.put("/api/profile/email",{newEmail:t,confirmNewEmail:n}),r}catch(i){throw i.response?Error(i.response.data.message):Error(i.message)}},updateCaloric:async e=>{console.log("update caloric data ",e);const{newCaloricPref:t}=e;let n={};console.log(t);let r=Number(t);try{if(isNaN(r))throw Error("not a number");return n=await Bu.put("/api/profile/caloricpref",{newCaloricPref:r}),n}catch(i){throw i.response?Error(i.response.data.message):Error(i.message)}},updateDietaryPref:async e=>{console.log("diet update")}},U6="#08e171dc",B6=ot.div`
    z-index: 3;
    /* border: solid 1px black; */
    background-color: ${U6};
