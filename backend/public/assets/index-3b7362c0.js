...
`,lw=()=>P(ow,{children:[d("h1",{children:"Find recipes | Meal Plan"}),d("img",{className:"logo",src:iw,alt:"Egg"}),d("img",{className:"logoText",src:aw,alt:"PantryPal"})]}),sw=Ve.section`
    width: 100%;
    max-width: 500px;
    padding: 0%;
    border-radius: 20px;
...
`;function uw(){const e=b.useRef(""),t=b.useRef(""),n=b.useRef(""),r=b.useRef("");let i=e.current.value,a=t.current.value,o=n.current.value,l=r.current.value;const[s,u]=b.useState(!1),[c,f]=b.useState([]),[m,w]=b.useState(!1),[g,y]=b.useState(!1),[x,h]=b.useState(!1),p=Qr();function v(z){return new RegExp(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/).test(z)}function S(){let z=[];return!v(l)&&l&&(y(!0),z.push("email format invalid")),a!==o&&(h(!0),z.push("passwords do not match")),z.length>0?(u(!0),z):[]}async function C(){u(!1);const z=S();if(z.length>0){f(z);return}try{const _=await fetch("http://localhost:4000/api/signup",{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:l,username:i,password:a})});if(_.status==401)throw Error("Username and/or Email already exists");if(_.status!=201)throw Error(`server response error ${_.statusText}`)}catch(_){u(!0),f([_.message]);return}try{const _=await fetch("http://localhost:4000/api/login",{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:i,password:a})});if(_.status===200){const T=await _.json();tr.set("loggedIn",{token:T.token,username:i})}else throw Error(_.statusText)}catch(_){u(!0),f([_.message]);return}p("/search")}return P(sw,{children:[P("section",{className:"form-sect",children:[P("form",{action:"#",onSubmit:z=>{z.preventDefault(),C()},children:[d("div",{className:"title",children:P("h2",{children:["Welcome to Pantry Pal ",d("br",{}),"Signup Here"]})}),P("div",{className:"input-container",children:[g&&d("span",{className:"error-marker",children:"*"}),d("label",{className:"input-tag",htmlFor:"email",children:"Email"}),d("input",{className:g?"error-container":"",ref:r,onChange:z=>{l=z.target.value,y(!1)},id:"email",type:"text",required:!0}),g&&d("span",{className:"error-marker",children:"*"})]}),P("div",{className:"input-container",children:[m&&d("span",{className:"error-marker",children:"*"}),d("label",{className:"input-tag",htmlFor:"username",children:"Username"}),d("input",{className:m?"error-container":"",ref:e,onChange:z=>{i=z.target.value},id:"username",type:"text",required:!0}),m&&d("span",{className:"error-marker",children:"*"})]}),P("div",{className:"input-container",children:[x&&d("span",{className:"error-marker",children:"*"}),d("label",{className:"input-tag",htmlFor:"password",children:"Password"}),d("input",{className:x?"error-container":"",ref:t,onChange:z=>{a=z.target.value,h(!1)},id:"password",type:"password",required:!0}),x&&d("span",{className:"error-marker",children:"*"})]}),P("div",{className:"input-container",children:[x&&d("span",{className:"error-marker",children:"*"}),d("label",{htmlFor:"confirmpassword",className:"input-tag",children:"Confirm Password"}),d("input",{className:x?"error-container":"",ref:n,onChange:z=>{o=z.target.value,h(!1)},id:"confirmpassword",type:"password",required:!0}),x&&d("span",{className:"error-marker",children:"*"})]}),d("div",{className:"submit-btn",children:d("button",{className:"btn",children:"Signup"})})]}),s&&d("section",{className:"error-container error-desc",children:P("div",{children:[d("h4",{children:"Please correct following errors"}),d("ul",{children:c.map((z,_)=>d("li",{children:z},_))})]})})]}),d("div",{className:"btn goto-btn",children:P(Kc,{to:"/login",children:["Already signed",d("br",{}),"up login here"]})})]})}let oi="#2C4001",cw="#F2E7AE";const fw=Ve.section`
...
`;function I6({recipeListArr:e,setDietFilter:t,dietFilter:n,setCategoryFilter:r,categoryFilter:i}){if(!e)return d("div",{children:"no filters available"});let a=new Set,o=new Set,l=["cheap","veryPopular","veryHealthy","sustainable","lowFodmap"];e.forEach(g=>{let y=g.diets;y.length>0&&y.forEach(x=>{n.includes(x)||a.add(x)}),l.forEach(x=>{g[x]&&!i.includes(x)&&o.add(x)})});let s=Array.from(a.values()),u=Array.from(o.values());function c(g){t(y=>y.includes(g)?y.filter(x=>x!==g):[...y,g])}function f(g){t(y=>y.filter(x=>x!==g))}function m(g){r(y=>y.includes(g)?y.filter(x=>x!==g):[...y,g])}function w(g){r(y=>y.filter(x=>x!==g))}return P(T6,{className:"main-filter-container",children:[n.length>0?P("section",{children:[d("h2",{children:"Selected filters: "}),d("ul",{children:n.map((g,y)=>d("li",{onClick:()=>{f(g)},className:"btn-filter",children:g},y+g))})]}):d("section",{}),i.length>0?P("section",{children:[d("h2",{children:"Category filters"}),d("ul",{children:i.map((g,y)=>d("li",{onClick:()=>{w(g)},className:"btn-filter",children:g},y+g))})]}):d("section",{}),P("section",{className:"filter-row",children:[d("h2",{children:"Dietary options:"}),d("ul",{className:"filter-options",children:s.length>0?s.map((g,y)=>d("li",{onClick:()=>{c(g)},className:"btn",children:d("span",{children:g})},y+g+1)):d(Gt,{})})]}),P("section",{className:"filter-row",children:[d("h2",{children:"Categories:"}),d("ul",{className:"filter-options",children:u.map((g,y)=>d("li",{onClick:()=>{m(g)},className:"btn",children:d("span",{children:g})},g+y+2))})]})]})}function L6(){const e="",t=Qr(),{isLoggedIn:n}=b.useContext(Tl);b.useEffect(()=>{n||t("/login")},[t,n]);const[r,i]=b.useState(""),[a,o]=b.useState([]),[l,s]=b.useState([]),[u,c]=b.useState([]),[f,m]=b.useState([]),[w,g]=b.useState(!1),[y,x]=b.useState(!1);b.useEffect(()=>{if(u.length>0||f.length>0){let v=$6(a,u,f);s(v);return}s(a)},[u,f,n]);const h=b.useRef("");async function p(){try{x(!0);const v=await qi.get(`${e}/api/searchbyingredient`,{params:{ingredients:r}});v!=null&&v.data&&g(!1);const S=v.data.map(_=>_.id),C=await qi.get("http://localhost:4000/api/recipeinformation",{params:{recipeIdList:S}});//! test remove
//! test remove
let z=O6(v.data,C.data);o(z),s(z),x(!1)}catch{g(!0)}}return P(fw,{children:[d("div",{className:"title",children:d("h1",{children:"Recipe Search"})}),d("div",{className:"searchContainer",children:P("form",{action:"#",onSubmit:v=>{v.preventDefault(),p()},children:[d("input",{ref:h,onChange:v=>i(v.target.value),id:"ingregients",value:r,type:"text",placeholder:"Enter your ingredients",className:"search"}),d("button",{className:"search-btn",children:"Search"})]})}),P("section",{className:"recipes-display",children:[d("div",{className:"filter-container",children:d(I6,{recipeListArr:l,setDietFilter:c,dietFilter:u,setCategoryFilter:m,categoryFilter:f})}),d("section",{className:"searchresults-container",children:d("div",{className:"searchResults",children:d("ul",{children:y?d(bh,{}):l.length>0?l.map(v=>d("li",{children:d(kh,{recipe:v},v.id)},v.id)):w?P("h3",{children:[" ","An error has occured, please try searching again."," "]}):P("h3",{className:"searchPrompt",children:[" ","Search for Ingredients to show Recipe Results."," "]})})})})]})]})}function $6(e,t,n){let r=e;return!t&&!n||t.length<=0&&n.length<=0?e:(t.length>0&&(r=e.filter(i=>{let a=i.diets;for(let o=0;o<t.length;o++){let l=t[o];if(!a.includes(l))return!1}return!0})),n.length>0&&(r=r.filter(i=>{for(let a=0;a<n.length;a++)if(!i[n[a]])return!1;return!0})),r)}const j6=Ve.section`
  background-color: white;
  color: #242424;
  height: 100vh;
...
`;function F6(){const e=b.useRef(null),t=b.useRef(null),[n,r]=b.useState(""),[i,a]=b.useState(""),[o,l]=b.useState(null),s=Qr(),{userProfile:u,isLoggedIn:c,setIsLoggedIn:f,setUserProfile:m}=b.useContext(Tl);return b.useEffect(()=>{e.current.focus()},[]),d(D6,{children:d("section",{className:"form-sect",children:P("form",{onSubmit:async g=>{g.preventDefault();try{const x=(await qi.post("/api/login",{username:n,password:i},{crossDomain:!0,withCredentials:!0})).data;f(!0),m(h=>x.userProfile?{...h,...x.userProfile}:h),s("/search")}catch(y){f(!1),console.log(y)}},children:[P("div",{className:"title",children:[d("div",{children:c&&"logged in"}),d("h2",{children:"Welcome Back!"})]}),o&&d("div",{className:"error-container",children:P("div",{className:"error-desc",children:[d("span",{className:"error-marker",children:"⚠"})," ",o]})}),P("div",{className:"input-container",children:[d("label",{className:"input-tag",htmlFor:"username",children:"Username"}),d("input",{id:"username",type:"text",placeholder:"Username",ref:e,value:n,onChange:g=>r(g.target.value),required:!0})]}),P("div",{className:"input-container",children:[d("label",{className:"input-tag",htmlFor:"password",children:"Password"}),d("input",{id:"password",type:"password",placeholder:"Password",ref:t,value:i,onChange:g=>a(g.target.value),required:!0})]}),d("div",{className:"submit-btn",children:d("button",{type:"submit",className:"btn",children:"Sign In"})})]})})})}let kt="#2C4001",Ua="#F2E7AE",H0="#59320F",Cs="#F2F2F2";const U6=Ve.section`
.recipeImgContainer {
  height: 50%;
  text-align: center;
  color: white;
...
`;function K6(){const e=Qr(),[t,n]=b.useState(!1),[r,i]=b.useState(1),[a,o]=b.useState("None"),[l,s]=b.useState(""),[u,c]=b.useState(null);return b.useEffect(()=>{document.cookie.split(";").some(w=>w.trim().startsWith("loggedIn="))||e("/login")},[e]),P(G6,{children:[P("form",{onSubmit:async m=>{n(!0),m.preventDefault();const w=await Q6(r,a,parseInt(l));c(w),n(!1)},children:[d("label",{htmlFor:"numberOfDays",children:"Number of days:"}),P("select",{id:"numberOfDays",value:r,onChange:m=>i(m.target.value),children:[d("option",{value:"1",children:"1"}),d("option",{value:"3",children:"3"}),d("option",{value:"5",children:"5"})]}),d("label",{htmlFor:"dietType",children:"Diet type:"}),P("select",{id:"dietType",value:a,onChange:m=>o(m.target.value),children:[d("option",{value:"None",children:"None"}),d("option",{value:"vegan",children:"Vegan"}),d("option",{value:"vegetarian",children:"Vegetarian"}),d("option",{value:"pescatarian",children:"Pescatarian"}),d("option",{value:"lacto-ovo-vegetarian",children:"Lacto-ovo-vegetarian"}),d("option",{value:"keto",children:"Keto"}),d("option",{value:"gluten-free",children:"Gluten-free"}),d("option",{value:"low-Fodmap",children:"Low Fodmap"})]}),d("label",{htmlFor:"dailyCalories",children:"Daily calories:"}),d("input",{id:"dailyCalories",type:"number",min:"0",step:"1",value:l,onChange:m=>s(m.target.value)}),d("button",{type:"submit",children:"Get Meal Plan"}),t?d(bh,{}):null]}),u&&P("table",{children:[d("thead",{children:P("tr",{children:[d("th",{children:"Day"}),d("th",{children:"Meal"}),d("th",{children:"Food"}),d("th",{children:"Calories"})]})}),d("tbody",{children:u.map(m=>{const w=Object.entries(m).filter(([y])=>y!=="Day"&&y!=="TotalCalories"),g=w.reduce((y,[,x])=>y+x.Calories,0);return w.flatMap(([y,x],h)=>[P("tr",{children:[h===0&&d("td",{rowSpan:w.length+1,children:m.Day}),d("td",{children:y}),d("td",{children:x.Meal}),d("td",{children:x.Calories})]},`${y}-${x.Meal}`),h===w.length-1&&d("tr",{children:P("td",{colSpan:"3",align:"right",children:["Total Day Calories : ",g]})},`${y}-TotalCalories`)])})})]})]})}const X6=qy`
