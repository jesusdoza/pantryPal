...
`;function $6({recipeListArr:e,setDietFilter:t,dietFilter:n,setCategoryFilter:r,categoryFilter:i}){if(!e)return d("div",{children:"no filters available"});let a=new Set,o=new Set,l=["cheap","veryPopular","veryHealthy","sustainable","lowFodmap"];e.forEach(g=>{let y=g.diets;y.length>0&&y.forEach(x=>{n.includes(x)||a.add(x)}),l.forEach(x=>{g[x]&&!i.includes(x)&&o.add(x)})});let s=Array.from(a.values()),u=Array.from(o.values());function c(g){t(y=>y.includes(g)?y.filter(x=>x!==g):[...y,g])}function f(g){t(y=>y.filter(x=>x!==g))}function m(g){r(y=>y.includes(g)?y.filter(x=>x!==g):[...y,g])}function w(g){r(y=>y.filter(x=>x!==g))}return z(L6,{className:"main-filter-container",children:[n.length>0?z("section",{children:[d("h2",{children:"Selected filters: "}),d("ul",{children:n.map((g,y)=>d("li",{onClick:()=>{f(g)},className:"btn-filter",children:g},y+g))})]}):d("section",{}),i.length>0?z("section",{children:[d("h2",{children:"Category filters"}),d("ul",{children:i.map((g,y)=>d("li",{onClick:()=>{w(g)},className:"btn-filter",children:g},y+g))})]}):d("section",{}),z("section",{className:"filter-row",children:[d("h2",{children:"Dietary options:"}),d("ul",{className:"filter-options",children:s.length>0?s.map((g,y)=>d("li",{onClick:()=>{c(g)},className:"btn",children:d("span",{children:g})},y+g+1)):d(Kt,{})})]}),z("section",{className:"filter-row",children:[d("h2",{children:"Categories:"}),d("ul",{className:"filter-options",children:u.map((g,y)=>d("li",{onClick:()=>{m(g)},className:"btn",children:d("span",{children:g})},g+y+2))})]})]})}function j6(){const e="http://localhost:4000",t=Yr(),{isLoggedIn:n}=b.useContext(Gr);b.useEffect(()=>{n||t("/login")},[t,n]);const[r,i]=b.useState(""),[a,o]=b.useState([]),[l,s]=b.useState([]),[u,c]=b.useState([]),[f,m]=b.useState([]),[w,g]=b.useState(!1),[y,x]=b.useState(!1);b.useEffect(()=>{if(u.length>0||f.length>0){let v=M6(a,u,f);s(v);return}s(a)},[u,f,n]);const h=b.useRef("");async function p(v){x(!0);try{const S=await qi.get(`${e}/api/searchbyingredient`,{params:{ingredients:v}});S!=null&&S.data&&g(!1);const C=S.data.map(_=>_.id),O=await qi.get(`${e}/api/recipeinformation`,{params:{recipeIdList:C}});//! test remove
//! test remove
let P=R6(S.data,O.data);o(P),s(P),x(!1)}catch{g(!0)}}return z(pw,{children:[d("div",{className:"title",children:d("h1",{children:"Recipe Search"})}),d("div",{className:"searchContainer",children:z("form",{action:"#",onSubmit:v=>{v.preventDefault(),p(r)},children:[d("input",{ref:h,onChange:v=>i(v.target.value),id:"ingregients",value:r,type:"text",placeholder:"Enter your ingredients",className:"search"}),d("button",{className:"search-btn",children:"Search"})]})}),z("section",{className:"recipes-display",children:[d("div",{className:"filter-container",children:d($6,{recipeListArr:l,setDietFilter:c,dietFilter:u,setCategoryFilter:m,categoryFilter:f})}),d("section",{className:"searchresults-container",children:d("div",{className:"searchResults",children:d("ul",{children:y?d(zh,{}):l.length>0?l.map(v=>d("li",{children:d(Ch,{recipe:v},v.id)},v.id)):w?z("h3",{children:[" ","An error has occured, please try searching again."," "]}):z("h3",{className:"searchPrompt",children:[" ","Search for Ingredients to show Recipe Results."," "]})})})})]})]})}function M6(e,t,n){let r=e;return!t&&!n||t.length<=0&&n.length<=0?e:(t.length>0&&(r=e.filter(i=>{let a=i.diets;for(let o=0;o<t.length;o++){let l=t[o];if(!a.includes(l))return!1}return!0})),n.length>0&&(r=r.filter(i=>{for(let a=0;a<n.length;a++)if(!i[n[a]])return!1;return!0})),r)}const F6=Ve.section`
  background-color: white;
  color: #242424;
  height: 100vh;
...
`;function B6(){const e=b.useRef(null),t=b.useRef(null),[n,r]=b.useState(""),[i,a]=b.useState(""),[o,l]=b.useState(null),s=Yr(),{userProfile:u,isLoggedIn:c,setIsLoggedIn:f,setUserProfile:m}=b.useContext(Gr);return b.useEffect(()=>{e.current.focus()},[]),d(U6,{children:d("section",{className:"form-sect",children:z("form",{onSubmit:async g=>{g.preventDefault();try{const x=(await qi.post("http://localhost:4000/api/login",{username:n,password:i},{crossDomain:!0,withCredentials:!0})).data;f(!0),m(h=>x.userProfile?{...h,...x.userProfile}:h),s("/search")}catch(y){f(!1),console.log(y)}},children:[z("div",{className:"title",children:[d("div",{children:c&&"logged in"}),d("h2",{children:"Welcome Back!"})]}),o&&d("div",{className:"error-container",children:z("div",{className:"error-desc",children:[d("span",{className:"error-marker",children:"⚠"})," ",o]})}),z("div",{className:"input-container",children:[d("label",{className:"input-tag",htmlFor:"username",children:"Username"}),d("input",{id:"username",type:"text",placeholder:"Username",ref:e,value:n,onChange:g=>r(g.target.value),required:!0})]}),z("div",{className:"input-container",children:[d("label",{className:"input-tag",htmlFor:"password",children:"Password"}),d("input",{id:"password",type:"password",placeholder:"Password",ref:t,value:i,onChange:g=>a(g.target.value),required:!0})]}),d("div",{className:"submit-btn",children:d("button",{type:"submit",className:"btn",children:"Sign In"})})]})})})}let bt="#2C4001",Ba="#F2E7AE",Y0="#59320F",Ps="#F2F2F2";const H6=Ve.section`
.recipeImgContainer {
  height: 50%;
  text-align: center;
  color: white;
