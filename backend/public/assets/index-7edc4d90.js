...
`;function w5(){const e=x.useRef(null),t=x.useRef(null),[n,r]=x.useState(""),[i,a]=x.useState(""),[o,l]=x.useState(null),s=ds(),{userProfile:u,isLoggedIn:c,setIsLoggedIn:f,setUserProfile:p}=x.useContext(Si);return x.useEffect(()=>{e.current.focus()},[]),h(y5,{children:N("section",{className:"login-container",children:[h("div",{children:h("img",{src:Hd,alt:"Pantry Pal Logo",className:"logo"})}),h("section",{className:"form-sect",children:N("form",{onSubmit:async g=>{g.preventDefault();try{const b=(await Vs.post("/api/login",{username:n,password:i},{crossDomain:!0,withCredentials:!0})).data;f(!0),p(d=>b.userProfile?{...d,...b.userProfile}:d),s("/search")}catch(v){f(!1),console.log(v)}},children:[N("div",{className:"title",children:[h("div",{children:c&&"logged in"}),h("h2",{children:"Welcome Back!"})]}),o&&h("div",{className:"error-container",children:N("div",{className:"error-desc",children:[h("span",{className:"error-marker",children:"⚠"})," ",o]})}),N("div",{className:"input-container",children:[h("label",{className:"input-tag",htmlFor:"username"}),h("input",{id:"username",type:"text",placeholder:"Username",ref:e,value:n,onChange:g=>r(g.target.value),required:!0})]}),N("div",{className:"input-container",children:[h("label",{className:"input-tag",htmlFor:"password"}),h("input",{id:"password",type:"password",placeholder:"Password",ref:t,value:i,onChange:g=>a(g.target.value),required:!0})]}),h("div",{className:"submit-btn",children:h("button",{type:"submit",className:"btn",children:"Sign In"})}),h("span",{children:"Don't have an account?"}),h(rt,{className:"page",to:"/signup",children:"Sign up"})]})})]})})}let Lt="#2C4001",Io="#F2E7AE",qh="#59320F",Hu="#F2F2F2";const b5=ot.section`
.recipeImgContainer {
  height: 50%;
  text-align: center;
  color: white;
