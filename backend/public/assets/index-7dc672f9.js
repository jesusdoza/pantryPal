...
`;function P6(){const[e,t]=b.useState([]);return b.useEffect(()=>{async function n(){try{const r=qt.get("loggedIn"),i=r?JSON.parse(r):null,a=i?i.username:null;if(!a){alert("Please log in to get saved recipes.");return}const o=await Bo.post("http://localhost:4000/api/getSavedRecipes",{username:a});t(o.data)}catch(r){console.error("Error fetching saved recipes:",r)}}n()},[]),P(z6,{children:[d("div",{className:"title",children:d("h1",{children:"Saved Recipes"})}),d("div",{className:"saved-recipes",children:d("ul",{children:e.map(n=>d("li",{children:d(gh,{recipe:n.recipeJson,showDelete:!0})},n._id))})})]})}const N6=Ve.section`
    width: 100%;
    max-width: 500px;
