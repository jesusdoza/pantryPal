...
`;function M6(){const[e,t]=b.useState([]),n="http://localhost:4000",{isLoggedIn:r,userProfile:i}=b.useContext(Gr);return b.useEffect(()=>{async function a(){try{if(!r){alert("Please log in to get saved recipes.");return}const o=await qi.post(`${n}/api/getSavedRecipes`,{username:i.username});t(o.data)}catch(o){console.error("Error fetching saved recipes:",o)}}a()},[]),z(j6,{children:[d("div",{className:"title",children:d("h1",{children:"Saved Recipes"})}),d("div",{className:"saved-recipes",children:d("ul",{children:e.map(a=>d("li",{children:d(kh,{recipe:a.recipeJson,showDelete:!0})},a._id))})})]})}const F6=Ve.section`
    width: 100%;
    max-width: 500px;
...
`,d5="/assets/error-58915e09.png";function Pf({errorsArr:e=["errorsArr Empty"],showError:t=!1}){function n(r){return r.map((a,o)=>d("li",{className:"error_container",children:z("div",{className:"error_item",children:[d("div",{className:"img__container",children:d("img",{src:d5,alt:"error symbol"})}),d("p",{children:a})]})},ht()))}return t?d(f5,{children:d("div",{className:"error container",children:d("div",{className:"row",children:z("section",{className:"container col",children:[d("h3",{children:"Please correct errors"}),d("ul",{className:"error__list",children:e.length>0?n(e):d(Gt,{})})]})})})}):d(Gt,{})}function p5({children:e,setIsDisplayed:t,scrollToRef:n}){b.useRef("");function r(){t(!1)}return d(u5,{children:z("main",{children:[d("div",{onClick:()=>{r()},className:"back__blur "}),d("div",{ref:n,className:"container row ",children:d("section",{id:"modal",className:"",children:e})})]})})}const zs=qi.create({baseURL:"http://localhost:4000",headers:{"Content-Type":"application/json"},withCredentials:!0});function W0(e,t){return e===t}function m5(e){return new RegExp(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/).test(e)}async function h5(e,t){const n=await JSON.stringify({token:t,username:e});Uo.set("loggedIn",n),Uo.set("loggedIn",n)}const Ha={updatePassword:async e=>{const{newPassword:t,confirmNewPassword:n,oldPassword:r}=e;let i={};try{if(!W0(t,n))throw Error("passwords dont match")}catch(a){throw console.log("password confirm error"),Error(a.message)}try{if(i=await zs.put("/api/profile/password",{newPassword:t,oldPassword:r}),i.data.profileUpdate){console.log("token update ");const a=i.data.username,o=i.data.token;await h5(a,o)}}catch(a){throw console.log("server request sent and error"),Error(a.response.data.message)}return console.log("password update success"),i},updateEmail:async e=>{const{newEmail:t,confirmNewEmail:n}=e;let r={};console.log("update email service front");try{if(!W0(t,n))throw Error("emails dont match");if(!m5(t))throw Error("emails improper format");return r=await zs.put("/api/profile/email",{newEmail:t,confirmNewEmail:n}),r}catch(i){throw i.response?Error(i.response.data.message):Error(i.message)}},updateCaloric:async e=>{console.log("update caloric data ",e);const{newCaloricPref:t}=e;let n={};console.log(t);let r=Number(t);try{if(isNaN(r))throw Error("not a number");return n=await zs.put("/api/profile/caloricpref",{newCaloricPref:r}),n}catch(i){throw i.response?Error(i.response.data.message):Error(i.message)}},updateDietaryPref:async e=>{console.log("diet update")}},g5="#08e171dc",v5=Ve.div`
    z-index: 3;
    /* border: solid 1px black; */
    background-color: ${g5};
