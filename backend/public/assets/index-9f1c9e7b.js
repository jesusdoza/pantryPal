...
`;function V6(){const e=b.useRef(null),t=b.useRef(null),[n,r]=b.useState(""),[i,a]=b.useState(""),[o,l]=b.useState(null),s=dl(),{userProfile:u,isLoggedIn:c,setIsLoggedIn:d,setUserProfile:h}=b.useContext(Gr);return b.useEffect(()=>{e.current.focus()},[]),f(H6,{children:f("section",{className:"form-sect",children:z("form",{onSubmit:async g=>{g.preventDefault();try{const x=(await Zi.post("/api/login",{username:n,password:i},{crossDomain:!0,withCredentials:!0})).data;d(!0),h(m=>x.userProfile?{...m,...x.userProfile}:m),s("/search")}catch(v){d(!1),console.log(v)}},children:[z("div",{className:"title",children:[f("div",{children:c&&"logged in"}),f("h2",{children:"Welcome Back!"})]}),o&&f("div",{className:"error-container",children:z("div",{className:"error-desc",children:[f("span",{className:"error-marker",children:"⚠"})," ",o]})}),z("div",{className:"input-container",children:[f("label",{className:"input-tag",htmlFor:"username",children:"Username"}),f("input",{id:"username",type:"text",placeholder:"Username",ref:e,value:n,onChange:g=>r(g.target.value),required:!0})]}),z("div",{className:"input-container",children:[f("label",{className:"input-tag",htmlFor:"password",children:"Password"}),f("input",{id:"password",type:"password",placeholder:"Password",ref:t,value:i,onChange:g=>a(g.target.value),required:!0})]}),f("div",{className:"submit-btn",children:f("button",{type:"submit",className:"btn",children:"Sign In"})})]})})})}let bt="#2C4001",Ba="#F2E7AE",Q0="#59320F",_s="#F2F2F2";const W6=Ve.section`
.recipeImgContainer {
  height: 50%;
  text-align: center;
  color: white;
