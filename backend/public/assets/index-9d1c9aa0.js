...
`;function F6(){const e=b.useRef(null),t=b.useRef(null),[n,r]=b.useState(""),[i,a]=b.useState(""),[o,l]=b.useState(null),s=Qr(),{userProfile:u,isLoggedIn:c,setIsLoggedIn:f,setUserProfile:m}=b.useContext(Tl);return b.useEffect(()=>{e.current.focus()},[]),p(D6,{children:p("section",{className:"form-sect",children:P("form",{onSubmit:async g=>{g.preventDefault();try{const x=(await qi.post("/api/login",{username:n,password:i},{crossDomain:!0,withCredentials:!0})).data;f(!0),m(h=>x.userProfile?{...h,...x.userProfile}:h),s("/search")}catch(v){f(!1),console.log(v)}},children:[P("div",{className:"title",children:[p("div",{children:c&&"logged in"}),p("h2",{children:"Welcome Back!"})]}),o&&p("div",{className:"error-container",children:P("div",{className:"error-desc",children:[p("span",{className:"error-marker",children:"⚠"})," ",o]})}),P("div",{className:"input-container",children:[p("label",{className:"input-tag",htmlFor:"username",children:"Username"}),p("input",{id:"username",type:"text",placeholder:"Username",ref:e,value:n,onChange:g=>r(g.target.value),required:!0})]}),P("div",{className:"input-container",children:[p("label",{className:"input-tag",htmlFor:"password",children:"Password"}),p("input",{id:"password",type:"password",placeholder:"Password",ref:t,value:i,onChange:g=>a(g.target.value),required:!0})]}),p("div",{className:"submit-btn",children:p("button",{type:"submit",className:"btn",children:"Sign In"})})]})})})}let kt="#2C4001",Ua="#F2E7AE",H0="#59320F",Cs="#F2F2F2";const U6=Ve.section`
.recipeImgContainer {
  height: 50%;
  text-align: center;
  color: white;
