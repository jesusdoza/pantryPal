...
`;function c6(){const[e,t]=x.useState([]),n="",{userProfile:r}=x.useContext(bi);return x.useEffect(()=>{async function i(){try{const a=await zs.post(`${n}/api/getSavedRecipes`,{username:r.username});t(a.data)}catch(a){console.error("Error fetching saved recipes:",a)}}i()},[]),N(u6,{children:[h("div",{className:"title",children:h("h1",{children:"Saved Recipes"})}),h("div",{className:"saved-recipes",children:h("ul",{children:e.map(i=>h("li",{children:h(Ov,{recipe:i.recipeJson,showDelete:!0})},i._id))})})]})}let rr="#2C4001",Wh="#dae082",f6="#F2E7AE",Nr="#F2F2F2";const d6=ot.section`
    height: 100%;
...
`;function p6(){const e=x.useRef(null),t=x.useRef(null),[n,r]=x.useState(""),[i,a]=x.useState(""),[o,l]=x.useState(null),s=cs(),{userProfile:u,isLoggedIn:c,setIsLoggedIn:f,setUserProfile:m}=x.useContext(bi);return x.useEffect(()=>{e.current.focus()},[]),h(d6,{children:N("section",{className:"login-container",children:[h("div",{children:h("img",{src:jd,alt:"Pantry Pal Logo",className:"logo"})}),h("section",{className:"form-sect",children:N("form",{onSubmit:async g=>{g.preventDefault();try{const b=(await zs.post("/api/login",{username:n,password:i},{crossDomain:!0,withCredentials:!0})).data;f(!0),m(d=>b.userProfile?{...d,...b.userProfile}:d),s("/search")}catch(v){f(!1),console.log(v)}},children:[N("div",{className:"title",children:[h("div",{children:c&&"logged in"}),h("h2",{children:"Welcome Back!"})]}),o&&h("div",{className:"error-container",children:N("div",{className:"error-desc",children:[h("span",{className:"error-marker",children:"⚠"})," ",o]})}),N("div",{className:"input-container",children:[h("label",{className:"input-tag",htmlFor:"username"}),h("input",{id:"username",type:"text",placeholder:"Username",ref:e,value:n,onChange:g=>r(g.target.value),required:!0})]}),N("div",{className:"input-container",children:[h("label",{className:"input-tag",htmlFor:"password"}),h("input",{id:"password",type:"password",placeholder:"Password",ref:t,value:i,onChange:g=>a(g.target.value),required:!0})]}),h("div",{className:"submit-btn",children:h("button",{type:"submit",className:"btn",children:"Sign In"})}),h("span",{children:"Don't have an account?"}),h(nt,{className:"page",to:"/signup",children:"Sign up"})]})})]})})}let Lt="#2C4001",No="#F2E7AE",Yh="#59320F",Uu="#F2F2F2";const m6=ot.section`
.recipeImgContainer {
  height: 50%;
  text-align: center;
  color: white;
...
`;let Ro;const h6=new Uint8Array(16);function g6(){if(!Ro&&(Ro=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!Ro))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return Ro(h6)}const Ye=[];for(let e=0;e<256;++e)Ye.push((e+256).toString(16).slice(1));function v6(e,t=0){return(Ye[e[t+0]]+Ye[e[t+1]]+Ye[e[t+2]]+Ye[e[t+3]]+"-"+Ye[e[t+4]]+Ye[e[t+5]]+"-"+Ye[e[t+6]]+Ye[e[t+7]]+"-"+Ye[e[t+8]]+Ye[e[t+9]]+"-"+Ye[e[t+10]]+Ye[e[t+11]]+Ye[e[t+12]]+Ye[e[t+13]]+Ye[e[t+14]]+Ye[e[t+15]]).toLowerCase()}const y6=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),Gh={randomUUID:y6};function Nt(e,t,n){if(Gh.randomUUID&&!t&&!e)return Gh.randomUUID();e=e||{};const r=e.random||(e.rng||g6)();if(r[6]=r[6]&15|64,r[8]=r[8]&63|128,t){n=n||0;for(let i=0;i<16;++i)t[n+i]=r[i];return t}return v6(r)}function w6(){var u;const t=(u=yi().state)==null?void 0:u.recipe,n=t.dishTypes.map(c=>h("li",{children:c},Nt())),r=t.extendedIngredients.map(c=>N("li",{children:[c.amount," ",c.unit," ",h("img",{src:`https://spoonacular.com/cdn/ingredients_100x100/${c.image}`})," ",c.name]},Nt()));console.log(t);const i=t.analyzedInstructions[0].steps.map(c=>h("li",{children:c.step},Nt())),a=t.summary.replace(/<.*?>/g,""),o=t.extendedIngredients.length,l=t.aggregateLikes,s=t.diets.map(c=>h("li",{children:c},Nt()));return h(m6,{children:N("div",{className:"recipeContainer",children:[N("div",{className:"recipeImgContainer",children:[N("div",{className:"imageContainer",children:[h("img",{className:"recipeImg",src:t.image,alt:t.title}),h("button",{className:"saveBtn",children:h(it,{icon:ah,className:"saveIcon"})})]}),N("section",{className:"recipeDetails",children:[h("div",{className:"titleContainer",children:h("h1",{className:"recipeTitle",children:t.title})}),N("div",{className:"quickInfoContainer",children:[N("section",{className:"quickInfoItem",children:[h(it,{icon:J4,className:"quickIcon"}),N("h2",{className:"recipeTime",children:[t.readyInMinutes," minutes"]})]}),N("section",{children:[h(it,{icon:q4,className:"quickIcon"}),N("h2",{className:"recipeTime",children:[o," Ingredients"]})]}),N("section",{children:[h(it,{icon:ah,className:"quickIcon"}),N("h2",{className:"recipeTime",children:[l," Likes"]})]})]}),h("section",{className:"recipeSummary",children:h("p",{children:a})}),N("section",{className:"recipeTags",children:[h("div",{className:"recipeCategory",children:n}),h("div",{className:"recipeDiets",children:s})]})]})]}),h("div",{className:"recipeHead",children:h("div",{className:"recipeStart",children:N("div",{className:"ingredientCard",children:[N("h2",{children:["Servings: ",t.servings]}),h("input",{type:"number",placeholder:t.servings}),h("h2",{children:"What you'll need:"}),h("div",{className:"recipeIngredient",children:r})]})})}),N("div",{className:"instructionsCard",children:[h("h2",{children:t.title}),N("div",{className:"instructionContainer",children:[h("div",{children:h("img",{className:"instructionImg",src:t.image,alt:t.title})}),N("div",{className:"recipeInstructions",children:[h("h2",{children:"Instructions:"}),h("ol",{children:i})]})]})]})]})})}async function b6(e,t,n){const r="http://localhost:4000/api/getMealPlanner";try{const i=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({numberOfDays:e,dietType:t,dailyCalories:n})});if(!i.ok)throw new Error(`HTTP error ${i.status}`);return await i.json()}catch(i){return console.error("Error:",i),null}}const x6=ot.section`
  width: max(50%, 800px);
  padding: 2%;
  border-radius: 20px;
  margin: 2% auto;
...
`;function S6(){const[e,t]=x.useState(!1),[n,r]=x.useState(1),[i,a]=x.useState("None"),[o,l]=x.useState(""),[s,u]=x.useState(null);return N(x6,{children:[N("form",{onSubmit:async f=>{t(!0),f.preventDefault();const m=await b6(n,i,parseInt(o));u(m),t(!1)},children:[h("label",{htmlFor:"numberOfDays",children:"Number of days:"}),N("select",{id:"numberOfDays",value:n,onChange:f=>r(f.target.value),children:[h("option",{value:"1",children:"1"}),h("option",{value:"3",children:"3"}),h("option",{value:"5",children:"5"})]}),h("label",{htmlFor:"dietType",children:"Diet type:"}),N("select",{id:"dietType",value:i,onChange:f=>a(f.target.value),children:[h("option",{value:"None",children:"None"}),h("option",{value:"vegan",children:"Vegan"}),h("option",{value:"vegetarian",children:"Vegetarian"}),h("option",{value:"pescatarian",children:"Pescatarian"}),h("option",{value:"lacto-ovo-vegetarian",children:"Lacto-ovo-vegetarian"}),h("option",{value:"keto",children:"Keto"}),h("option",{value:"gluten-free",children:"Gluten-free"}),h("option",{value:"low-Fodmap",children:"Low Fodmap"})]}),h("label",{htmlFor:"dailyCalories",children:"Daily calories:"}),h("input",{id:"dailyCalories",type:"number",min:"0",step:"1",value:o,onChange:f=>l(f.target.value)}),h("button",{type:"submit",children:"Get Meal Plan"}),e?h(Av,{}):null]}),s&&N("table",{children:[h("thead",{children:N("tr",{children:[h("th",{children:"Day"}),h("th",{children:"Meal"}),h("th",{children:"Food"}),h("th",{children:"Calories"})]})}),h("tbody",{children:s.map(f=>{const m=Object.entries(f).filter(([g])=>g!=="Day"&&g!=="TotalCalories"),y=m.reduce((g,[,v])=>g+v.Calories,0);return m.flatMap(([g,v],b)=>[N("tr",{children:[b===0&&h("td",{rowSpan:m.length+1,children:f.Day}),h("td",{children:g}),h("td",{children:v.Meal}),h("td",{children:v.Calories})]},`${g}-${v.Meal}`),b===m.length-1&&h("tr",{children:N("td",{colSpan:"3",align:"right",children:["Total Day Calories :"," ",y]})},`${g}-TotalCalories`)])})})]})]})}const E6=Xx`
...
`,C6="#ffffff",k6="#40a140",P6=" #ffea00d0",O6=" #28bee4",A6="#ffffff",N6="#25271843",R6=ot.section`
    background: ${C6};
...
`,I6="#2b3f0124",_6="#eae6e6",F6="#a8a6a6",T6="#000000",$6="#595959f",L6=ot.section`
    width: 100%;
    position: fixed;
    top: 0;
    bottom: 0;
...
`,z6="/assets/error-58915e09.png";function tp({errorsArr:e=["errorsArr Empty"],showError:t=!1}){function n(r){return r.map((a,o)=>h("li",{className:"error_container",children:N("div",{className:"error_item",children:[h("div",{className:"img__container",children:h("img",{src:z6,alt:"error symbol"})}),h("p",{children:a})]})},Nt()))}return t?h(M6,{children:h("div",{className:"error container",children:h("div",{className:"row",children:N("section",{className:"container col",children:[h("h3",{children:"Please correct errors"}),h("ul",{className:"error__list",children:e.length>0?n(e):h(rn,{})})]})})})}):h(rn,{})}function j6({children:e,setIsDisplayed:t,scrollToRef:n}){x.useRef("");function r(){t(!1)}return h(L6,{children:N("main",{children:[h("div",{onClick:()=>{r()},className:"back__blur "}),h("div",{ref:n,className:"container row ",children:h("section",{id:"modal",className:"",children:e})})]})})}const Bu=zs.create({baseURL:"",headers:{"Content-Type":"application/json"},withCredentials:!0});function Kh(e,t){return e===t}function V6(e){return new RegExp(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/).test(e)}async function U6(e,t){const n=await JSON.stringify({token:t,username:e});Fl.set("loggedIn",n),Fl.set("loggedIn",n)}const Io={updatePassword:async e=>{const{newPassword:t,confirmNewPassword:n,oldPassword:r}=e;let i={};try{if(!Kh(t,n))throw Error("passwords dont match")}catch(a){throw console.log("password confirm error"),Error(a.message)}try{if(i=await Bu.put("/api/profile/password",{newPassword:t,oldPassword:r}),i.data.profileUpdate){console.log("token update ");const a=i.data.username,o=i.data.token;await U6(a,o)}}catch(a){throw console.log("server request sent and error"),Error(a.response.data.message)}return console.log("password update success"),i},updateEmail:async e=>{const{newEmail:t,confirmNewEmail:n}=e;let r={};console.log("update email service front");try{if(!Kh(t,n))throw Error("emails dont match");if(!V6(t))throw Error("emails improper format");return r=await Bu.put("/api/profile/email",{newEmail:t,confirmNewEmail:n}),r}catch(i){throw i.response?Error(i.response.data.message):Error(i.message)}},updateCaloric:async e=>{console.log("update caloric data ",e);const{newCaloricPref:t}=e;let n={};console.log(t);let r=Number(t);try{if(isNaN(r))throw Error("not a number");return n=await Bu.put("/api/profile/caloricpref",{newCaloricPref:r}),n}catch(i){throw i.response?Error(i.response.data.message):Error(i.message)}},updateDietaryPref:async e=>{console.log("diet update")}},B6="#08e171dc",H6=ot.div`
    z-index: 3;
    /* border: solid 1px black; */
    background-color: ${B6};
