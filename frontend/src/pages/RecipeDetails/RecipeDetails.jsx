...
import ServingCounter from "../../components/ServingCounter/ServingCounter";
...
export default function RecipeDetails() {
  ...
  const instructionStep = recipeData.analyzedInstructions[0].steps.map(
    (instruction) => {
  ...
  const ingredientAmount = recipeData.extendedIngredients.map((ingredient) => {
        ...
        <div className="recipeImgContainer">
          ...
          <section className="recipeDetails">
            ...
            <section className="recipeTags">
              <div className="recipeCategory">{recipeType}</div>
              <div className="recipeDiets">{recipeDiets}</div>
            </section>
          </section>
        </div>
